...
# Role/position
role: Associate Professor # of Cell Biology; Assistant Professor in Pathology; Assistant Professor in Orthopaedic Surgery; Affiliate of the Duke Regeneration Center; Member of the Duke Cancer Institute
...
#education:
#  courses:
#    - course: PhD in Muscle Regeneration, Epigenetics
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:yarui.diao@duke.edu'
#  - icon: twitter
#    icon_pack: fab
#    link: https://twitter.com/GeorgeCushen
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=7H1ugs4AAAAJ&hl=en
#  - icon: github
#    icon_pack: fab
...
[Duke Cell Biology Faculty Page](https://www.cellbio.duke.edu/profile/yarui-diao)
