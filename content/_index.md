      ...
      text: |
        <section style="display: flex; align-items: center; justify-content: space-between; max-width: 1200px; margin: auto; gap: 40px;">
          ...
          <div id="lab-slides" style="flex: 1; position: relative; overflow: hidden; max-width: 600px;">
            <img src="https://github.com/DiaoLab/DiaoLab.github.io/tree/main/assets/media/lab4.jpg" style="width:100%; display:block;">
            <img src="https://github.com/DiaoLab/DiaoLab.github.io/tree/main/assets/media/lab3.jpg" style="width:100%; display:none;">
            <img src="https://github.com/DiaoLab/DiaoLab.github.io/tree/main/assets/media/lab2.jpg" style="width:100%; display:none;">
            <img src="https://github.com/DiaoLab/DiaoLab.github.io/tree/main/assets/media/lab1.jpg" style="width:100%; display:none;">
          </div>
  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <img src="https://github.com/DiaoLab/DiaoLab.github.io/tree/main/assets/media/research.jpg" alt="Research" style="float:right; margin: 0 0 15px 20px; width:40%; border-radius:12px; opacity:0.85;">
